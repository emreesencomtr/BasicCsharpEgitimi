...
namespace SinemaFragmanProjesi_
{
    public partial class Form1 : Form
    {
        ...
        {
            MessageBox.Show("Bu proje Emre Esen tarafından yapılmıştır.","Bilgi",MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
        }
        ...
        private void aynıYıldınızınAltındaToolStripMenuItem_Click(object sender, EventArgs e)
        {
            webBrowser1.Navigate("https://www.youtube.com/watch?v=8Bvv75Cq_2Q");
            label1.Visible=true;
        ...
        {
            webBrowser1.Navigate("https://www.youtube.com/watch?v=RH6P5pMbe4s0");
            label1.Visible = true;
